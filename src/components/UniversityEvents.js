...
const UniversityEvents = () => {
  return (
    <section className="bg-gray-100 py-1">
      <div className="container mx-auto mt-28 sm:mt-36 px-8 sm:px-24 sm:py-2">
        {/* Top Section */}
        <div className=" mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
          ...
          <div className="md:col-span-2 relative">
            ...
            <div className="absolute top-0 left-0 p-6 text-white sm:pt-28 ">
              <h3 className="text-xl font-medium font-playfair mb-4">
          ...
          <div className="col-span-1 shadow-lg  overflow-hidden">
            ...
            <div className="py-4 px-5">
              <h3 className="text-lg tracking-wider text-indigo-900 font-playfair font-medium mb-4">
              ...
              <a
                href="#"
                className="text-indigo-900 uppercase tracking-widest text-sm font-medium "
              >
                Read More &rarr;
              </a>
            </div>
