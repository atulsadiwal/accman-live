...
const HeroSection = () => {
  ...
  <h6 className="tracking-widest mb-2 text-xl md:text-xl uppercase">BEST Institute IN DELHI NCR</h6>
  ...
  <p className=" text-sm md:text-sm font-semibold leading-5 sm:leading-9">
    Since 2006, ACCMAN provides students with high-quality professional
    education.<br className="hidden md:block" /> Together with us, you
    will have deeper knowledge of the subjects important <br className="hidden md:block" />
