            ...
            <div className="w-full h-screen grid grid-cols-1 md:grid-cols-2 mt-12 sm:mt-0">
                ...
                >
                    <div className="absolute bottom-0 left-0 bg-yellow-500 py-6 md:py-8 px-4  sm:px-10 max-w-xs md:max-w-xs">
                        <h3 className="text-sm font-semibold text-gray-900 mb-3 font-playfair tracking-wider">Open Doors, Endless Opportunities</h3>
                        ...
                        <button className="text-gray-800 text-xs tracking-widest hover:text-yellow-600 transition">VIEW ALL FACULTIES →</button>
                    </div>
                </div>

                <div className="bg-indigo-900  text-white py-3 px-8 sm:py-4 sm:px-20  flex flex-col justify-center">
                    <p className="text-[0.8rem] font-medium mb-4 tracking-[0.2rem]">AKG UNIVERSITY</p>

                    <h1 className="text-xl md:text-4xl font-semibold font-playfair mb-2 leading-relaxed tracking-wider">We Are Open For Opportunities</h1>

                    <p className="text-[0.75rem] mb-4">Embracing endless possibilities, our university is a gateway to diverse opportunities. Join us in a journey of discovery, learning, and growth. We are open for opportunities.</p>
