        ...
        <>
            <div className="container mx-auto px-6 py-10 sm:py-32">
                <div className="grid md:grid-cols-2 gap-8">
                    <div className='py-6'>
                        <h6 className="text-blue-900 text-xl tracking-widest uppercase mb-2">To The Journey Ahead</h6>
                        <h2 className="text-6xl font-semibold mb-6 tracking-wide font-playfair text-gray-800">
                            Gain Valuable Knowledge & Experience
                        </h2>
                        <div className="space-y-6">
                            {data.map((item) => (
                                <div key={item.id} className="flex space-x-4 items-center">
                                    <div className="bg-blue-900 text-white flex items-center justify-center h-14 w-14 px-3 shadow-md rounded-full text-sm hover:bg-yellow-500 hover:text-black">
                                        {item.icon}
                                    </div>
                                    <div>
                                        <h3 className="text-lg font-semibold font-playfair text-gray-800">{item.title}</h3>
                                        <p className="text-base leading-relaxed text-gray-800 mt-1">{item.description}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
